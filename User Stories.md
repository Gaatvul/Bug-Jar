...
| View reports | A user should be able to view reports. | 10 |
...
| Create new bug report | A user should be able to create a new bug report. Information required is title, description, project name, category and criticality | 10 |
...
| Sort reports by date | A user should be able to filter reports by date created. New to old and old to new. | 40 |
| Sort reports by Criticality | A user should be able to sort reports by level of criticality. High to low and low to high. | 40 |
| Sort reports by priority | A user should be able to sort reports by level of priority. High to low and low to high. | 40 |
| Filter reports by assignee | A user should be able to filter reports by the name of the person assigned to the report. | 40 |
| Filter reports by category | A user should be able to filter reports by the category assigned to the report. | 40 |
| Add Comments | A user should be able to add a comment to an report **AND** see previous comments for that report. | 40 |
| Attach Documents to report | A user should be able to attach documents | 50 |
| Bug report Information | A bug report should have the following information: <ul> <li> A bug id </li> <li> A description </li> <li> Attachments </li> <li> Project Assigned to </li> <li> Assignee </li> <li> Reporter </li> <li> Comments </li> <li> Status </li> <li> Criticality </li> <li> Category </li> <li> Priority </li> </ul> | 10 |
...
| Bug Report Retention | All bug reports should be saved persistently for future interaction. | 10 |
| User account Retention | All user accounts and their details should be saved persistently for future use. | 10 |
...
| Save bug report changes | A bug report should have the option to save changes made to the report. The save option should be a button to be pressed. | 20 |
