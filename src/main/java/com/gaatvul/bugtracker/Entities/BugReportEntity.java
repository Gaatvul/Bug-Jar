...
public class BugReportEntity {
    ...
    private int id;
    private String title, description, projectAssignedTo, assignee, reporter, owner, criticality, category, priority,
            status;
    ...
    public String toString() {
        return "BugReportEntity [id=" + id + ", title=" + title + ", description=" + description
                ...
                + ", owner=" + owner + ", criticality=" + criticality + ", category=" + category + ", priority="
                + priority + ", status=" + status + ", createdOn=" + createdOn + "]";
    }
